...
「まだ言語化されていない挙動」を発見し、裁可を経て検査可能な仕様に昇格させるループの
...
**常設化の判断は実績データで行う**:
1 巡目終了後に「コスト・発見率・裁可結果の内訳」を計測し、助言的運用から必須ゲートへの
昇格を判断する。実績なしに常設化しない
...
- **ループの維持**: ルールが増えるほど探索で見つかるものが増え、裁可の負荷が上がる。
